...
rabbit.result.manager.changeTab=function(_61){
var _62=selectorUtil.getElementsByName("target"+this.currentPageId);
for(var i=0;i<_62.length;i++){
if(_62[i].childNodes.length==2){
_62[i].firstChild.style.display="block";
_62[i].firstChild.nextSibling.style.display="none";
}else{
_62[i].getElementsByTagName("fill")[0].setAttribute("color","white");
}
}
var _62=selectorUtil.getElementsByName("target"+_61);
for(var i=0;i<_62.length;i++){
if(_62[i].childNodes.length==2){
_62[i].firstChild.style.display="none";
_62[i].firstChild.nextSibling.style.display="block";
}else{
_62[i].getElementsByTagName("fill")[0].setAttribute("color","#D3D3D3");
}
}
this.currentPageId=_61;
};
YAHOO.widget.Menu.prototype._onBeforeShow=function(_63,_64){
var _65,n,_66,_67=this.cfg.getProperty("container");
...
_66=this.srcElement;
if(_66){
if(_66.tagName.toUpperCase()=="SELECT"){
if(Dom.inDocument(_66)){
this.render(_66.parentNode);
}else{
this.render(_67);
}
}else{
...
var _68=this.parent,_69;
if(!_68&&this.cfg.getProperty("position")=="dynamic"){
this.cfg.refireEvent("xy");
}
if(_68){
_69=_68.parent.cfg.getProperty("submenualignment");
this._initSubTree();
this.cfg.setProperty("context",[_68.element,_69[0],_69[1]]);
this.align();
}
};
