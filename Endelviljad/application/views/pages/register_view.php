...
<!--Start form-->
				<form id="register-form" class="form-horizontal" method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" onsubmit="return validateForm('register-form')">
					<div class="form-group <?php echo $nameErr;?>">
						<label for="usrName" class="col-sm-4 control-label">Ettevõtte nimi</label>
						<div class="col-sm-8">
							<input class="form-control" type="text" id="usrName" name="name" maxlength="100" value="<?php echo $fields[0]; ?>" ></input>
						</div>
					</div>
					<div class="form-group <?php echo $regCodeErr;?>">
						<label for="usrRegCode" class="col-sm-4 control-label">Registrikood</label>
						<div class="col-sm-8">
							<input class="form-control" type="text" id="usrRegCode" name="regCode" maxlength="8" value="<?php echo $fields[1];?>" />
						</div>
					</div>
					<div class="form-group <?php echo $streetErr;?>">
						<label class="col-sm-8 col-sm-offset-1">Ettevõtte aadress:</label>
						<label for="usrAdrStreet" class="col-sm-4 control-label">Tänava&#47;Talu</label>
						<div class="col-sm-8">
							<input class="form-control" type="text" id="usrAdrStreet" name="street" maxlength="50" value="<?php echo $fields[2];?>" />
						</div>
					</div>
					<div class="form-group <?php echo $houseNrErr;?>">
						<label for="usrAdrHouseNr" class="col-sm-4 control-label">Maja&#47;Korteri nr</label>
						<div class="col-sm-8">
							<input class="form-control" type="text" id="usrAdrHouseNr" name="houseNr" maxlength="7" value="<?php echo $fields[3];?>" />
						</div>
					</div>
					<div class="form-group <?php echo $postalCodeErr;?>">
						<label for="usrAdrPostalCode" class="col-sm-4 control-label">Sihtnumber</label>
						<div class="col-sm-8">
							<input class="form-control" type="text" id="usrAdrPostalCode" name="postalCode" maxlength="6" value="<?php echo $fields[4];?>" />
						</div>
					</div>
					...
					<div class="form-group <?php echo $phoneErr;?>">
						...
						<div class="col-sm-8">
							<input class="form-control" type="text" id="usrTel" name="phone" maxlength="10" value="<?php echo $fields[6];?>" />
						</div>
					</div>
					...
					<div class="form-group <?php echo $emailErr;?>">
						...
						<div class="col-sm-8">
							<input class="form-control" type="text" id="usrEmail" name="email" maxlength="50" value="<?php echo $fields[8];?>" />
						</div>
					</div>
