...
class ProductsModel extends CI_Model {
    ...
    public function getData($limit, $start_row) {
        $this->db->select('Toode.id as toode_id, Sale.id as sale_id, Toode.Vili, Toode.Sort, Kategooria, Sale.kogus as Kogus, Sale.hind as Hind, Toode.Asukoht, Toode.Pilt');
